export const JavaLargeFileUploader = () => {
    ...
    function processNewFiles(newFiles) {
        ...
        for (pendingFileId in newFiles) {
            ...
            fileForPost.data = new Object();

            // fileForPost.data.type = "CloudFile";
            // fileForPost.data.targetDirId = 1;

            // fileForPost.data.type = "ArchiveAttachmentFile";
            // fileForPost.data.targetArchiveLibId = 13;
            // fileForPost.data.targetArchiveId = 1;

            fileForPost.data.type = "ArchiveFile";
            fileForPost.data.targetArchiveLibId = 105;
            fileForPost.data.targetArchiveId = 970;
