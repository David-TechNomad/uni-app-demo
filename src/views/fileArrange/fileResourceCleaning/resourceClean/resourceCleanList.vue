    ...
    <section>
        ...
        <div class="mainDoc">
            <div class="mainCon mainBorrow mainBorrowTop">
                <div class="formData relative">
                    <el-tabs v-model="activeName" @tab-click="handleClick" type="card" class="erpTab">
                    <el-tab-pane label="待处理" name="0">
                        <el-tabs class="mainBorrowBottom childTab whiteBgColor" v-model="eleSubTab"  @tab-click="changeSubTab" >
                            <el-tab-pane label="重复数据" name="0">
                            </el-tab-pane>
                            <el-tab-pane label="垃圾数据" name="2">
                            </el-tab-pane>
                            <el-tab-pane label="相关错误" name="3">
                            </el-tab-pane>
                            <el-tab-pane label="疑似涉密" name="4">
                            </el-tab-pane>
                    ...
                    <div class="searchKey boxshow">
                        <el-form  :inline="true" :model="filters" class="doneForm topParamsForm" v-show="DaoRu">
                            <el-form-item>
                            ...
                            <div class="rt">
                                <el-form-item>
                                    <el-button class="defaultBtn"  @click="GuadeleteList" type="primary">不变</el-button>
                                </el-form-item>
                                <el-form-item>
                                    <el-button class="redBtn"  @click="GuadeleteList" type="primary">删除</el-button>
                                </el-form-item>
                                <el-form-item>
                                    <el-button class="defaultBtn"  @click="GuadeleteList" type="primary">关联</el-button>
                                </el-form-item>
                            </div>
                            <div class="clear"></div>
                        </el-form>
                        <!-- 批量挂接 查询 -->
                        <el-form  :inline="true" :model="Gfilters" class="doneForm topParamsForm" v-show= "GuaJie">
                            <el-form-item label="挂接状态：" prop="fondName" class="SelectItem checkName">
                                <el-select v-model="Gfilters.fondName" placeholder="请选择任务状态" @change="selectGet" style="width:85%" size="small">
                                <el-option label="已匹配" value="1"></el-option>
                                <el-option label="挂接中" value="2"></el-option>
                                <el-option label="挂接完成" value="3"></el-option>
                            </el-select>
                            </el-form-item>
                            <el-form-item class="" label="挂接日期：" ref="year">
                            ...
                            <el-form-item>
                                <el-button class="defaultBtn"  @click="PdataCheckeds" type="primary">检索</el-button>
                            </el-form-item>
                            <el-form-item style="float:right">
                                <el-button class="redBtn"  @click="GuadeleteList" type="primary">删除</el-button>
                            </el-form-item>
                            <el-form-item style="float:right">
                                <el-button class="defaultBtn"  @click="GuadeleteList" type="primary">入库</el-button>
                            </el-form-item>
                            <div class="clear"></div>
                        </el-form>
                    </div>
                    <el-button class="defaultBtn r0 t0 absolute"  @click="toAddPreClean" type="primary">新增预清洗</el-button>
                </div>
                    <div class="mainCon basicList pd10 boxshow bgwhite" v-show="DaoRu">
                       <div class="">
                           <el-table border stripe :height="bodyHeight - 110" :data="mockList.mackDataObj.res" highlight-current-row v-loading="listLoading" class="defaultTable" header-row-class-name="tableHeader">
                                <el-table-column
                                    type="selection"
                                    width="55">
                                </el-table-column>
                                ...
                                <el-table-column  label="操作"  width="300">
                                    ...
                                    <el-button class="tabletoolBtn" @click="handSelected">不变</el-button>
                                    <el-button class="tabletoolBtn" @click="handSelected">删除</el-button>
                                    <el-button class="tabletoolBtn" @click="handSelected">编辑</el-button>
                                    <el-button class="tabletoolBtn" @click="handSelected">关联</el-button>
                                    </template>
                                </el-table-column>
                                <el-table-column prop="id" label="预清洗结果">
                                </el-table-column>
                                <el-table-column  prop="birth" label="类型">
                                </el-table-column>
                                <el-table-column  prop="name" label="档号">
                                </el-table-column>
                                <el-table-column   prop="id" label="预清洗日期">
                                </el-table-column>
                                <el-table-column  prop="sex" label="操作人">
                                </el-table-column>
                                <el-table-column   prop="sex" label="档案馆">
                                </el-table-column>
                                <el-table-column   prop="age" label="全宗">
                                </el-table-column>
                                <el-table-column   prop="id" label="控制标识">
                                </el-table-column>
                                <el-table-column prop="sex"  label="密级">
                                </el-table-column>
                            </el-table>
                         <!--工具条分页-->
...
import Service from './resourceCleanList.service';
...
Component.registerHooks([
 ...
 @Component({
    ...
    toAddPreClean() {
            this['$router'].push({
                path:"/fileArrange/fileResourceCleaning/addPreClean/addPreClean",
            })
    }
    //任务导入列表 删除
    deleteList(){
    ...
    .mainDoc{
      ...
      .mainCon{
        ...
        .mainBorrowBottom{
          ...
          .erpTab .el-tabs__content .el-tabs__item{
          ...
          .el-tabs__header .el-tabs__item.is-active {
                color: #428bca;
                border-bottom: 4px solid #2fa1e2;
            }
