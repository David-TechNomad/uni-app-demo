    ...
    <section>
        <el-dialog
           ...
           <div class="box-card" v-if="tableData.length>1" style="margin-top: 20px">
             ...
             <div class="box-card mt10" v-if="!(tableData.length>1)">        
                <div class="userTime left">回复信息</div><BR/>               
                 <el-form  ref="ruleForm" :rules='ruleForm' label-width="80px"  style="clear:both" :model="form"> 
                        <el-form-item label="标题" prop="postTitle" class="mt10">
                            <el-input size="small" v-model="form.postTitle"></el-input>
                        </el-form-item>  
                        <el-form-item label="内容" prop="postContent"  class="mt10">
                            <el-input type="textarea" size="small" v-model="form.postContent"></el-input>
                        </el-form-item> 
                        <el-form-item label="上传附件"   class="mt10">
                            <el-upload                           
                                    :action="uploadUrl"
                                    :data="uploadType" 
            ...
            <span slot="footer" class="dialog-footer">
                <el-button @click="addReplay('ruleForm')" class="defaultBtn" v-if="!(tableData.length>1)">确定</el-button>
...
<script lang="ts">
    ...
    export default class eidt extends Vue{
       ...
       downexportAllFile(id){            
            if(id) {
                 window.open(process.env.upload_BASEURL+'/file/simple/download?fileId='+id)
            }
       };
