            ...
            <div class="mainCon basicList">
                ...
                <ul class="rowsForm">
                    ...
                    <el-row>
                        ...
                        <el-col :span="5"><div class="grid-content bg-purple-light"><span class="span2">{{detailData.createDate.substr(0,10)}}</span></div></el-col>
                    </el-row>
                    <el-row>
    ...
    export default class processManagementUpdate extends Vue{
       ...
       //审批人弹框确定
        ...
        applySubmit(){
            ...
            for(let child of this.stepMap){
                if(!((child.step == 0 || child.isApprovalNode) && child.auditResult != null)){
                    let obj = {
                        id:child.id,
                        auditUser:{
