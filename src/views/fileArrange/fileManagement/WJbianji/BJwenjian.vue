...
<script lang="ts">
    ...
    import Service from './BJwenjian.service';
    ...
    export default class appfileManagement extends Vue{
        ...
        Uint8Array:{reader: HTMLFormElement};
        QZHArr:any=[];
        FLhArr:any=[];
                ...
                if(valid){
                    ...
                    Service.SaveFile({recomputeDh:true,fondId:this.fondId,libId:this.bids,data:this.addfile}).then(res=>{
                        if(res.data.succeeded){
                            ...
                            this.keepRight = true;
                            window.sessionStorage.setItem('WBres',JSON.stringify(res.data.data));
                            if(this.keepRight){
                                this.addFileName = '';
                                this.fileSingle = {};
                                this.Suces("保存成功。");
        ...
        /** 断点续传集合 END*/
        mounted(){
            var str = window.sessionStorage.getItem('BJwenjian');
