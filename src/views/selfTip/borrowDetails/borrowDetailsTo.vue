        ...
        <div class="contentbox contentbox-full "> 
          <div class="relative mt10"> 
                    <div class="TabRBtn tabRtext">
                         <span class="rt">状态：审批部分通过</span>
                    </div>                     
                 <el-tabs v-model="activeName" type="card" class="erpTab">
                      <el-tab-pane label="借阅单号：2018061708" name="first">   
                 ...
                 <div class="relative mt10"> 
                    <div class="TabRBtn tabRtext">
                      ...
                      <el-tabs v-model="activeName" type="card" class="erpTab">                                                    
                            <el-tab-pane label="借阅文档" name="first">
                                 <div class="boxshow">   
                                   <el-table
                                        :data="tableData"
                                        border
                                        ...
                                        <el-table-column  prop="name" label="操作"  width="120">
                                             <template slot-scope="scope">                                                 
                                                 ...
                                                 <el-button class="tabletoolBtn" @click="toPreview">阅览</el-button>
                                              </template>
                                        </el-table-column>
                                        <el-table-column prop="name" label="门类名称">
                                         ...
                                         <el-table-column prop="address" label="馆藏馆名称">                                      
                                        </el-table-column>
                                         <el-table-column prop="date" label="控制标识">                                      
                                        </el-table-column>
                                         <el-table-column prop="date" label="利用方式">                                      
                                        </el-table-column>
                                         <el-table-column prop="date" label="全宗名称">                                      
                                        </el-table-column>
                                         <el-table-column prop="date" label="利用数量">                                      
                                         </el-table-column>
                  ...
                  <el-tabs v-model="activeName" type="card" class="erpTab mt10">                      
                        <el-tab-pane label="流程跟踪" name="first"> 
                               <div class="boxshow">   
                                   <el-table
                                        :data="tableData"
                                        border
                                       ...
                                       <el-table-column type="index" width="50" label="序号"> </el-table-column>                         
                                        <el-table-column prop="name" label="步骤">
                                         ...
                                         <el-table-column prop="address" label="审批结果">
                                               <template slot-scope="scope">  
                                                    审批部分通过                                               
                                                 <el-button class="tabletoolBtn">详情</el-button> </template>                                           
                                        </el-table-column>
                                         <el-table-column prop="address" label="审批意见">  
                                                <template slot-scope="scope">  
                                                    具体审批意见                                              
                                              </template>                                    
                                        </el-table-column>
...
<script lang="ts">
    ...
    export default class examCheck extends Vue{
      ...
      tableData: any =[{
        ...
        toPreview(){         
             this.$router.push({
                path:'/selfTip/borrowDetails/borrowDetailsPreview'});
        };
