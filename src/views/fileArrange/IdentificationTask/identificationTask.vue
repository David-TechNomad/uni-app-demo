                                   ...
                                   <el-table
                                        ...
                                        <el-table-column  prop="name" label="操作"  width="120">
                                             <template slot-scope="scope">                                                 
                                                 <el-button class="tabletoolBtn" @click="toDetails">详情</el-button>
                                              </template>
                                        </el-table-column>
                                        <el-table-column prop="name" label="档案馆代码">
                                        </el-table-column>
                                         <el-table-column prop="address" label="档案馆名称">                                      
                                        </el-table-column>
                                         <el-table-column prop="address" label="鉴定类型">                                      
                                        </el-table-column>
                                         <el-table-column prop="address" label="鉴定任务">                                      
                                        </el-table-column>
                                         <el-table-column prop="date" label="鉴定级别">                                      
                                        </el-table-column>
                                         <el-table-column prop="date" label="计划鉴定数量">                                      
                                        </el-table-column>
                                         <el-table-column prop="date" label="鉴定开始日期">                                      
                                        </el-table-column> 
                                         <el-table-column prop="date" label="预计完成日期">                                      
                                        </el-table-column>
                                         <el-table-column prop="date" label="鉴定创建人">                                      
                                        </el-table-column> 
...
<script lang="ts">
    ...
    export default class identificationTask extends Vue{
      ...
      tableData: any =[{
        ...
        toDetails(){
          this.$router.push({path:'/fileArrange/IdentificationTask/identificationDetails'});
        };
