...
<script lang="ts">
    ...
    import Service from './addinrecord.service';
    ...
    export default class appfileManagement extends Vue{
        ...
        /** 断点续传集合 END*/
        mounted(){
            var str = window.sessionStorage.getItem('addInrecord');
            ...
            //     this.mj = res.data.data.MJ;
            //     this.nd = res.data.data.ND;
            //     this.parentId = res.data.data.PARENTID;
            //     this.ajh = res.data.data.AJH;
            //     this.bgqx = res.data.data.BGQX;
            //     this.bm = res.data.data.BM;
            //     this.flh = res.data.data.FLH;
            //     this.qzh =  res.data.data.QZH;
            //     this.xmbh = res.data.data.XMBH;
            //     this.xmmcnew = res.data.data.XMMCNEW;
            //     // this.qzh = res.data.QZH;
             Service.getEditField(this.bids).then(res=>{
                    if(res.data.succeeded){
                        this.addArray=res.data.data;
                        this.addfile={};
                        ...
                        // this.addfile.DQQZH=this.qzh;
                        // this.addfile.ND = this.nd;
                        // this.addfile.MJ = this.mj.toString();
                        // this.addfile.AJH = this.ajh;
                        // this.addfile.BGQX =  this.bgqx;//保管期限
                        // this.addfile.BM = this.bm;
                        // this.addfile.FLH = this.flh;
                        // this.addfile.XMBH = this.xmbh;
                        // this.addfile.XMMCNEW = this.xmmcnew;
