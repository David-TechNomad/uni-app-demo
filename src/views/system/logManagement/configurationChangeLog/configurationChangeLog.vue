    ...
    <section class="wrapprSection classLevelDescriptionView">
        ...
        <div class="searchKey boxshow contentbox-full">           
              <el-form :inline="true" >
                ...
                <el-form-item>
                    <el-button class="defaultBtn" @click="configurefind">查询</el-button> 
                </el-form-item>
             </el-form>
        </div>
                ...
                <div class="ta-r">     
                    <el-button class="defaultBtn" @click="exportData()">导出</el-button>
                                   ...
                                   <el-table
                                        ...
                                        <el-table-column prop="createPerson" label="登录用户名" align="left">                                           
                                        </el-table-column>
                                        <el-table-column prop="userName" label="操作用户" align="left">                                           
                                        </el-table-column>
...
<script lang="ts">
  ...
  import Service from './configurationChangeLog.service';
   @Component
    export default class appSuperSearch extends Vue{  
      ...
      tableData: any =[];
        ...
        configurefind(){
            Service.getSystemOperationLogList(this.Gfilters).then((res)=>{
                // console.log(res)
        ...
        getDictListByDictId(val){
            
        };
        exportData(){
            Service.systemExport({
                ...
                link.href = url;
                link.setAttribute('download', '配置变更日志.xlsx');
