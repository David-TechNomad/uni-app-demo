    ...
    <section>
        ...
        <div class="">
                <div class="formData">
                    ...
                    <el-tab-pane label="全省三级政务服务网" name="0"></el-tab-pane>
                    <el-tab-pane label="省馆数字档案集成系统" name="1"></el-tab-pane>
                    </el-tabs>
                    <!-- 任务列表 查询 -->
                    ...
                    <div class="mainCon basicList pd10 boxshow bgwhite mt10" v-show="DaoRu">
                       <div class="">
                            <!-- <el-table style="width: 100%" border stripe :height="bodyHeight-30" :data="processTypeData" highlight-current-row v-loading="listLoading" class="defaultTable" header-row-class-name="tableHeader" @selection-change="selsChangeList">
...
import Service from './systemDocking.service';
