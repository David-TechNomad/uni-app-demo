...
<script lang="ts">
    ...
    import Service from './modelPrintFiles.service';
    ...
    export default class appSearch extends Vue{
        ...
        back():void{
            ...
            if(a =='1'){
                this['$router'].push({path:'/fileArrange/archivesManagent'});
			}else{
                this['$router'].push({path:'/fileArrange/archiveManagement/archiveIn'});
			}
