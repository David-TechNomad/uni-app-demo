                ...
                <el-form :model="basicForm" class="basicForm topParamsForm fileApplyForm validForm" label-width="120px" :rules="basicFormRules" ref="basicForm">
                    <div class="formItem topTitle">
                        <el-form-item label="标题：" ref="title" prop="title">
                            <el-input class="checkName percentName" readonly disabled v-model="detailData.transferLookup.title"></el-input>
                        </el-form-item>
                    </div>
                    <div class="clear formItem evenTitle whiteTitle">
                        <el-form-item label="申请人：" ref="name" class="lt" prop="name">
                            <el-input class="checkName percentName" readonly disabled v-model="detailData.transferLookup.applyPerson"></el-input>
                        </el-form-item>
                        <el-form-item label="申请人部门：" ref="company" class="lt basicItem" prop="company">
                            <el-input class="checkName percentName" readonly disabled v-model="detailData.transferLookup.applyDept"></el-input>
                        </el-form-item>
                        <el-form-item label="申请时间：" ref="date" class="lt basicItem" prop="date">
                            <el-input class="checkName percentName" readonly disabled v-model="detailData.transferLookup.applyDate"></el-input>
                        </el-form-item>
                    </div>
                    <div class="clear formItem evenTitle whiteTitle" v-show="tranferType">
                        <el-form-item label="接收单位：" ref="danwei" class="lt" prop="danwei">
                            <el-input class="checkName percentName" readonly disabled v-model="detailData.transferLookup.acceptOrg"></el-input>
                        </el-form-item>
                        <el-form-item label="接收部门：" ref="bumen" class="lt basicItem" prop="bumen">
                            <el-input class="checkName percentName" readonly disabled v-model="detailData.transferLookup.acceptDept"></el-input>
                        </el-form-item>
                    </div>
                     <div class="formItem topTitle">
                        <el-form-item label="移交数量：" ref="moveCount" prop="moveCount">
                            <el-input class="checkName percentName" readonly disabled v-model="detailData.transferLookup.transferCount"></el-input>
                        </el-form-item>
                    </div>
                    <div class="evenTitle">
                        <el-form-item class="things" label="移交说明：" ref="things"  prop="things">
                            <el-input type="textarea" class="checkName percentName" v-model="detailData.transferLookup.transferMemo"></el-input>
                        </el-form-item>
                    </div>
                </el-form>
            </div>
                ...
                <div class="tableCon">
                    <el-table tooltip-effect="dark" style="width: 100%" stripe :height="bodyHeight-100" :data="stepData" highlight-current-row class="indexTable containTable">
                        ...
                        <el-table-column prop="type" label="审批状态">
                            <template slot-scope="scope">
                               <span v-if="scope.row.stepType == 1 || scope.row.stepType == 2">已审批</span>
                               <span v-else>未审批</span>
                            </template>
                        </el-table-column>
                        <el-table-column label="操作" width="120px">
                            <template slot-scope="scope">
                                <span v-if="scope.row.stepType == 1 || scope.row.stepType == 2"></span>
    ...
    export default class processManagementUpdate extends Vue{
        ...
        console.log(this.stepData)
            ...
            for(let child of this.stepData){
                if(this.hangData.processId == child.processId){
       ...
       //审批人弹框确定
        ...
        //修改提交
        applySubmit(){
            let transferProcessList = [];
            for(let child of this.stepMap){
                if(child.stepType != 1 && child.stepType != 2){
                    let obj = {
                        id:child.processId,
                        auditUserId:child.userId
                    };
                    transferProcessList.push(obj);
                }
            };
            ...
            for(let child of this.recordData){
                ...
                transferRecordList.push(obj);
            }
            let parames = {
                transferId:this.row.id,
                transferMemo:this.detailData.transferLookup.transferMemo,
                transferProcessList:transferProcessList,
                transferRecordList:transferRecordList
            };
            Service.fileUpdateProcess(parames).then((res) =>{
                if(res.data.succeeded){
                    this['$message']({
                        message: "修改成功！",
                        type: 'success'
