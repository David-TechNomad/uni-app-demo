<template>
    <section>
        ...
        <div class="checkTable">
            <div class="tableCaption">查找结果</div>
            <el-table
                    :data="data"
                    style="width: 100%"
                    :stripe="true"
            ...
            >
                ...
                <el-table-column prop="libRankText" label="档案类型"></el-table-column>
                <el-table-column prop="problemTypeText" label="筛查结果"></el-table-column>
                <el-table-column prop="archiveCode" label="档号"></el-table-column>
                <el-table-column prop="duplicateCount" label="重复条数"></el-table-column>
...
<script lang="ts">
    ...
    import Service from './infileCheck.service';
    ...
    export default class check extends Vue{
        ...
        //档号筛查
        Checkdh():void{
            Service.CheckDH({fondId:this.fondId,kindId:this.kindId,conditions:this.searchContent,anJuanId:this.Id}).then(res=>{
        ...
        SaveNotes():void{
            ...
            for(var ind of this.data){
                if(ind.note){
                    var obj = {itemState:2,id:ind.id,note:ind.note};
                    arr.push(obj);
                };
            };
            Service.CheckDhNotes(arr).then(res=>{
                if(res.data.succeeded){}else{
                    this.getError(res.data.errorMessage)
                }
        ...
        created(){
            var str = window.sessionStorage.getItem('infilecheck');
