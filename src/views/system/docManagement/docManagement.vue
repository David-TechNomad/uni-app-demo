        ...
        <div class="scrollCon formDiv">
            <div class="tableCon">
                <!-- <el-form :model="fileForm" label-width="85px" :rules="ruleForm" ref="fileForm" class="addfiled">
                    ...
                    <el-form-item label="选择文档：" class="basicItem" prop= "upLists">
                        ...
                        <el-upload 
                            ...
                            <br/>
                    		<el-button slot="trigger" size="small" class="checkWay" type="primary" style="position:absolute;right:0;top:5px">选取文件</el-button>
                		</el-upload>
                    </el-form-item>
                   ...
                   <el-form :model="fileForm" label-width="85px" :rules="ruleForm" ref="fileForm" class="addfiled">
                    ...
                    <el-form-item label="选择文档："  ref='iploads' class="basicItem" prop= "upLists">
                    	<el-input class="aaaaa"  readOnly v-model='fileForm.upLists'></el-input>
                        <el-upload 
                    		class="upload-demo" 
                    		action="111" 
                    ...
                    <el-form-item label="备注：" class="basicItem" prop="content" style="margin-top:8px">
                        <el-input type="textarea" class="checkName percentName" v-model="fileForm.content"></el-input>
                    </el-form-item>
                </el-form>
            </div>
        </div>
...
<script lang="ts">
    ...
    import Service from './docManagement.service';
