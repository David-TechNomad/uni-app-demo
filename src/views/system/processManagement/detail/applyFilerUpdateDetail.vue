    ...
    <section>
            ...
            <div class="mainCon basicList">
                ...
                <ul class="rowsForm">
                    ...
                    <el-row>
                        ...
                        <el-col :span="5"><div class="grid-content bg-purple-light"><span class="span2">{{detailData.applyTime}}</span></div></el-col>
                    </el-row>
        ...
        <el-dialog class="fixModal" title="修改流程节点" :visible.sync="fileVisible" :close-on-click-modal="true" :model="ruleForm">
            <div class="scrollCon formDiv">
                <div class="tableCon">
                    <el-table tooltip-effect="dark" style="width: 100%" stripe :height="bodyHeight-100" :data="stepMap" highlight-current-row class="indexTable containTable">
